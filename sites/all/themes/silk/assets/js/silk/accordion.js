(function($) {
  ...
  $.fn.silkaccordion = function(options) {
    ...
    var settings = $.extend({
      ...
      contentClass: 'silk-accordion__content',
      headerClass: 'silk-accordion__header',
      navClass: 'silk-accordion__nav',
      tabClass: 'silk-accordion__section',
      openOnLoad: ''
    }, options);
    ...
    var toggle = function($context) {
      return function(e) {
        ...
        $context.find('[href="' + href + '"]').toggleClass('is-active').end();
